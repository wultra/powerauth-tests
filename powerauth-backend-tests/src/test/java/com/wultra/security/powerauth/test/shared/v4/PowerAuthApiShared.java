...
public class PowerAuthApiShared {
    ...
    public static void unlockVaultAndECDSASignatureTest(PowerAuthClient powerAuthClient, PowerAuthTestConfiguration config, PowerAuthVersion version) throws Exception {
        ...
        final byte[] encryptedEcDevicePrivateKeyBytes = Base64.getDecoder().decode((String) config.getResultStatusObject(version).get("encryptedEcDevicePrivateKey"));
        ...
        final byte[] encryptedPqcDevicePrivateKeyBytes = Base64.getDecoder().decode((String) config.getResultStatusObject(version).get("encryptedPqcDevicePrivateKey"));
