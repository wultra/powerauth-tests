...
class PowerAuthSignatureTest {
    ...
    void signatureEmptyDataTest() throws Exception {
        File dataFile = File.createTempFile("data_empty_v31", ".json");
    ...
    void signatureMaxFailedAttemptsTest() throws Exception {
        ...
        modelPrepare.setActivationName("test v31");
    ...
    void signatureOfflinePersonalizedValidTest() throws Exception {
        final CreatePersonalizedOfflineSignaturePayloadResponse offlineResponse = powerAuthClient.createPersonalizedOfflineSignaturePayload(
                config.getActivationIdV31(), offlineData);
        ...
        final VerifyOfflineSignatureResponse signatureResponse = powerAuthClient.verifyOfflineSignature(config.getActivationIdV31(), signatureBaseString, signature, true);
        assertTrue(signatureResponse.isSignatureValid());
        assertEquals(config.getActivationIdV31(), signatureResponse.getActivationId());
